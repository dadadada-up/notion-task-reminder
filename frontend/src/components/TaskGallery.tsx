...
const TaskGallery = ({ tasks, onTaskClick }: TaskGalleryProps) => {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
      {tasks.map((task) => (
        <div
          ...
          className={`group relative border-l-4 ${getStatusColor(task.status)} rounded-lg p-4 cursor-pointer hover:shadow-lg transition-all duration-200 transform hover:-translate-y-1`}
        >
          {/* Priority Badge */}
          ...
          {/* Task Name */}
          <h3 className="text-base font-semibold text-gray-900 mb-3 pr-8 line-clamp-2 group-hover:text-purple-600 transition-colors">
            {task.name}
          </h3>
